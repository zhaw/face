...
def get_convnet_executor(n_class, batch_size, ctx):
    ...
    fc1 = mx.sym.FullyConnected(data=flatten1, num_hidden=160)
    ...
    arg_shapes, output_shapes, aux_shapes = out.infer_shape(data=(batch_size, 3, 55, 47))
